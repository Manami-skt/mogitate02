...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => 'src/resources/views/fruits-img/kiwi.png',
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => 'src/resources/views/fruits-img/strawberry.png',
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => 'src/resources/views/fruits-img/orange.png',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => 'src/resources/views/fruits-img/watermelon.png',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => 'src/resources/views/fruits-img/peach.png',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => 'src/resources/views/fruits-img/muscat.png',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => 'src/resources/views/fruits-img/pineapple.png',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => 'src/resources/views/fruits-img/grapes.png',
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => 'src/resources/views/fruits-img/banana.png',
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => 'src/resources/views/fruits-img/melon.png',
